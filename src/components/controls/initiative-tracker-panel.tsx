...
// import { Switch } from '@/components/ui/switch'; // Auto-advance UI commented out
import { ScrollArea } from '@/components/ui/scroll-area';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { ListOrdered, PlusCircle, Trash2, RotateCcw } from 'lucide-react'; // ChevronRight removed
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function InitiativeTrackerPanel({
  ...
  // useEffect for syncing isActive has been removed as 'isActive' is now determined dynamically during render.
  // useEffect for managing currentParticipantIndex validity has moved to BattleBoardPage.
  ...
  const handleAddFormSubmit = (e: React.FormEvent) => {
    ...
    // Toast for success is handled in BattleBoardPage
  };

  return (
    <AccordionItem value="turn-tracker">
      <AccordionTrigger>
        <ListOrdered className="mr-2 h-5 w-5" /> Turn Tracker
      </AccordionTrigger>
        ...
        <Card>
          ...
          <CardContent className="p-4 pt-0">
            ...
            <div className="mt-4 flex gap-2">
              {/* Next Turn button removed from here, now in SidebarFooter of BattleBoardPage */}
              <AlertDialog>
                <AlertDialogTrigger asChild>
